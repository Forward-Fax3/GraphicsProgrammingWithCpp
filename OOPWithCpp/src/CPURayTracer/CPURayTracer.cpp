...
//			"RandTest", 
		...
		m_CameraSettingsUpdated |= ImGui::DragInt("Max Bounces", &cameraSettings.MaxBounces, 1.0f, 0, 8192);
		ImGui::End();

		cameraSettings.MaxBounces = glm::clamp(cameraSettings.MaxBounces, 0, 8192);
	}
